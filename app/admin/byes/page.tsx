                      ...
                      {request.isApproved === null && (
                        <div className="flex space-x-2">
                          ...
                          <button
                            ...
                            className="text-red-600 hover:text-red-900 dark:text-red-400 dark:hover:text-red-300 cursor-pointer disabled:cursor-not-allowed disabled:opacity-50 inline-flex items-center"
                          >
